    ...
    <section class="form__body">
      <form method="POST" action="homeAdmin.php" onsubmit="soumettreFormulaire(event)">
        ...
        <div class="button-group">
          <input type="submit" name="Ajouter" class="btn btn-warning" value="Ajouter">
          <i class="fas fa-plus" style="color: white; font-size: 1.1rem; margin-top: -0.35rem; margin-left: -1.5rem; width:30%"></i>
