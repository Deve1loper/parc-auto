...
if (!empty($data)) {
    ...
    $nom=$data[2]; //nom et prenom employe
...
<body>
   <form method="POST">
   <div id="ajouterreservation" style="margin-top: 200px; margin-left: 100px;"  class="modal fade" style=" ">
       <input type="text" name="numdemande" style="display:none;" value="<?php echo $num ?>" /> 
       <p> refuser les demande de  <?php echo $nom; ?> </p>
       <button name="refuser" style="background-color: green;font-size: 15px; width: 150px; height: 25px; cursor: pointer;">OK</button>
